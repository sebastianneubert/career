...
describe(`visit job sites to check if there are any new roles`, {
  retries: {
    runMode: 0,
    openMode: 0,
  },
  ...
  it('Check Scalable Capital', () => {
    ...
    cy.request('https://careers.smartrecruiters.com/ScalableGmbH/api/more?type=department&value=2519492&page=1').then((response)=>{
